-- Issue #258 follow-up: keep Schedule fast save aligned with the canonical guarded Worklog writer.
-- WorkRecord + SourceRef persistence delegates to save_my_worklog() so provenance/RLS/idempotency rules have one source of truth.
