...
test("local OCR recognize call returns without runtime failure",{timeout:90000},async()=>{
  ...
  assert.equal(diagnostic.recognizeReturned,true,`OCR recognize failed: ${diagnostic.error}`);
});
